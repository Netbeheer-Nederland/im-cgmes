...
| ---  | --- | --- | --- | --- |
| t1 | [cim:ExcBBC.t1](http://iec.ch/TC57/CIM100#ExcBBC.t1) | 1..1 <br />  [Seconds](Seconds.md)  | Controller time constant (<i>T1</i>) (&gt;= 0) | direct |
| t2 | [cim:ExcBBC.t2](http://iec.ch/TC57/CIM100#ExcBBC.t2) | 1..1 <br />  [Seconds](Seconds.md)  | Controller time constant (<i>T2</i>) (&gt;= 0) | direct |
| t3 | [cim:ExcBBC.t3](http://iec.ch/TC57/CIM100#ExcBBC.t3) | 1..1 <br />  [Seconds](Seconds.md)  | Lead/lag time constant (<i>T3</i>) (&gt;= 0) | direct |
| t4 | [cim:ExcBBC.t4](http://iec.ch/TC57/CIM100#ExcBBC.t4) | 1..1 <br />  [Seconds](Seconds.md)  | Lead/lag time constant (<i>T4</i>) (&gt;= 0) | direct |
| k | [cim:ExcBBC.k](http://iec.ch/TC57/CIM100#ExcBBC.k) | 1..1 <br />  [PU](PU.md)  | Steady state gain (<i>K</i>) (not = 0) | direct |
| vrmin | [cim:ExcBBC.vrmin](http://iec.ch/TC57/CIM100#ExcBBC.vrmin) | 1..1 <br />  [PU](PU.md)  | Minimum control element output (<i>Vrmin</i>) (&lt; ExcBBC | direct |
| vrmax | [cim:ExcBBC.vrmax](http://iec.ch/TC57/CIM100#ExcBBC.vrmax) | 1..1 <br />  [PU](PU.md)  | Maximum control element output (<i>Vrmax</i>) (&gt; ExcBBC | direct |
| efdmin | [cim:ExcBBC.efdmin](http://iec.ch/TC57/CIM100#ExcBBC.efdmin) | 1..1 <br />  [PU](PU.md)  | Minimum open circuit exciter voltage (<i>Efdmin</i>) (&lt; ExcBBC | direct |
| efdmax | [cim:ExcBBC.efdmax](http://iec.ch/TC57/CIM100#ExcBBC.efdmax) | 1..1 <br />  [PU](PU.md)  | Maximum open circuit exciter voltage (<i>Efdmax</i>) (&gt; ExcBBC | direct |
| xe | [cim:ExcBBC.xe](http://iec.ch/TC57/CIM100#ExcBBC.xe) | 1..1 <br />  [PU](PU.md)  | Effective excitation transformer reactance (<i>Xe</i>) (&gt;= 0) | direct |
| switch | [cim:ExcBBC.switch](http://iec.ch/TC57/CIM100#ExcBBC.switch) | 1..1 <br />  boolean  | Supplementary signal routing selector (<i>switch</i>) | direct |

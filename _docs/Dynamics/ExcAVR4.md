...
| ---  | --- | --- | --- | --- |
| ka | [cim:ExcAVR4.ka](http://iec.ch/TC57/CIM100#ExcAVR4.ka) | 1 <br />  float  | AVR gain (<i>K</i><i><sub>A</sub></i>) | direct |
| vrmn | [cim:ExcAVR4.vrmn](http://iec.ch/TC57/CIM100#ExcAVR4.vrmn) | 1 <br />  [PU](PU.md)  | Minimum AVR output (<i>V</i><i><sub>RMN</sub></i>) | direct |
| vrmx | [cim:ExcAVR4.vrmx](http://iec.ch/TC57/CIM100#ExcAVR4.vrmx) | 1 <br />  [PU](PU.md)  | Maximum AVR output (<i>V</i><i><sub>RMX</sub></i>) | direct |
| t1 | [cim:ExcAVR4.t1](http://iec.ch/TC57/CIM100#ExcAVR4.t1) | 1 <br />  [Seconds](Seconds.md)  | AVR time constant (<i>T</i><i><sub>1</sub></i>) (&gt;= 0) | direct |
| t2 | [cim:ExcAVR4.t2](http://iec.ch/TC57/CIM100#ExcAVR4.t2) | 1 <br />  [Seconds](Seconds.md)  | AVR time constant (<i>T</i><i><sub>2</sub></i>) (&gt;= 0) | direct |
| t3 | [cim:ExcAVR4.t3](http://iec.ch/TC57/CIM100#ExcAVR4.t3) | 1 <br />  [Seconds](Seconds.md)  | AVR time constant (<i>T</i><i><sub>3</sub></i>) (&gt;= 0) | direct |
| t4 | [cim:ExcAVR4.t4](http://iec.ch/TC57/CIM100#ExcAVR4.t4) | 1 <br />  [Seconds](Seconds.md)  | AVR time constant (<i>T</i><i><sub>4</sub></i>) (&gt;= 0) | direct |
| ke | [cim:ExcAVR4.ke](http://iec.ch/TC57/CIM100#ExcAVR4.ke) | 1 <br />  float  | Exciter gain (<i>K</i><i><sub>E</sub></i><i>)</i> | direct |
| vfmx | [cim:ExcAVR4.vfmx](http://iec.ch/TC57/CIM100#ExcAVR4.vfmx) | 1 <br />  [PU](PU.md)  | Maximum exciter output (<i>V</i><i><sub>FMX</sub></i>) | direct |
| vfmn | [cim:ExcAVR4.vfmn](http://iec.ch/TC57/CIM100#ExcAVR4.vfmn) | 1 <br />  [PU](PU.md)  | Minimum exciter output (<i>V</i><i><sub>FMN</sub></i>) | direct |
| kif | [cim:ExcAVR4.kif](http://iec.ch/TC57/CIM100#ExcAVR4.kif) | 1 <br />  float  | Exciter internal reactance (<i>K</i><i><sub>IF</sub></i>) | direct |
| tif | [cim:ExcAVR4.tif](http://iec.ch/TC57/CIM100#ExcAVR4.tif) | 1 <br />  [Seconds](Seconds.md)  | Exciter current feedback time constant (<i>T</i><i><sub>IF</sub></i>) (&gt;= ... | direct |
| t1if | [cim:ExcAVR4.t1if](http://iec.ch/TC57/CIM100#ExcAVR4.t1if) | 1 <br />  [Seconds](Seconds.md)  | Exciter current feedback time constant (<i>T</i><i><sub>1IF</sub></i>) (&gt;=... | direct |
| imul | [cim:ExcAVR4.imul](http://iec.ch/TC57/CIM100#ExcAVR4.imul) | 1 <br />  boolean  | AVR output voltage dependency selector (<i>I</i><i><sub>MUL</sub></i>) | direct |

...
| ---  | --- | --- | --- | --- |
| k1 | [cim:ExcELIN2.k1](http://iec.ch/TC57/CIM100#ExcELIN2.k1) | 1..1 <br />  [PU](PU.md)  | Voltage regulator input gain (<i>K1</i>) | direct |
| k1ec | [cim:ExcELIN2.k1ec](http://iec.ch/TC57/CIM100#ExcELIN2.k1ec) | 1..1 <br />  [PU](PU.md)  | Voltage regulator input limit (<i>K1ec</i>) | direct |
| kd1 | [cim:ExcELIN2.kd1](http://iec.ch/TC57/CIM100#ExcELIN2.kd1) | 1..1 <br />  [PU](PU.md)  | Voltage controller derivative gain (<i>Kd1</i>) | direct |
| tb1 | [cim:ExcELIN2.tb1](http://iec.ch/TC57/CIM100#ExcELIN2.tb1) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage controller derivative washout time constant (<i>Tb1</i>) (&gt;= 0) | direct |
| pid1max | [cim:ExcELIN2.pid1max](http://iec.ch/TC57/CIM100#ExcELIN2.pid1max) | 1..1 <br />  [PU](PU.md)  | Controller follow up gain (<i>PID1max</i>) | direct |
| ti1 | [cim:ExcELIN2.ti1](http://iec.ch/TC57/CIM100#ExcELIN2.ti1) | 1..1 <br />  [PU](PU.md)  | Controller follow up deadband (<i>Ti1</i>) | direct |
| iefmax2 | [cim:ExcELIN2.iefmax2](http://iec.ch/TC57/CIM100#ExcELIN2.iefmax2) | 1..1 <br />  [PU](PU.md)  | Minimum open circuit excitation voltage (<i>I</i><i><sub>efmax2</sub></i>) | direct |
| k2 | [cim:ExcELIN2.k2](http://iec.ch/TC57/CIM100#ExcELIN2.k2) | 1..1 <br />  [PU](PU.md)  | Gain (<i>K2</i>) | direct |
| ketb | [cim:ExcELIN2.ketb](http://iec.ch/TC57/CIM100#ExcELIN2.ketb) | 1..1 <br />  [PU](PU.md)  | Gain (<i>Ketb</i>) | direct |
| upmax | [cim:ExcELIN2.upmax](http://iec.ch/TC57/CIM100#ExcELIN2.upmax) | 1..1 <br />  [PU](PU.md)  | Limiter (<i>Upmax</i>) (&gt; ExcELIN2 | direct |
| upmin | [cim:ExcELIN2.upmin](http://iec.ch/TC57/CIM100#ExcELIN2.upmin) | 1..1 <br />  [PU](PU.md)  | Limiter (<i>Upmin</i>) (&lt; ExcELIN2 | direct |
| te | [cim:ExcELIN2.te](http://iec.ch/TC57/CIM100#ExcELIN2.te) | 1..1 <br />  [Seconds](Seconds.md)  | Time constant (<i>Te</i>) (&gt;= 0) | direct |
| xp | [cim:ExcELIN2.xp](http://iec.ch/TC57/CIM100#ExcELIN2.xp) | 1..1 <br />  [PU](PU.md)  | Excitation transformer effective reactance (<i>Xp</i>) | direct |
| te2 | [cim:ExcELIN2.te2](http://iec.ch/TC57/CIM100#ExcELIN2.te2) | 1..1 <br />  [Seconds](Seconds.md)  | Time Constant (<i>T</i><i><sub>e2</sub></i>) (&gt;= 0) | direct |
| ke2 | [cim:ExcELIN2.ke2](http://iec.ch/TC57/CIM100#ExcELIN2.ke2) | 1..1 <br />  [PU](PU.md)  | Gain (<i>Ke2</i>) | direct |
| ve1 | [cim:ExcELIN2.ve1](http://iec.ch/TC57/CIM100#ExcELIN2.ve1) | 1..1 <br />  [PU](PU.md)  | Exciter alternator output voltages back of commutating reactance at which sat... | direct |
| seve1 | [cim:ExcELIN2.seve1](http://iec.ch/TC57/CIM100#ExcELIN2.seve1) | 1..1 <br />  [PU](PU.md)  | Exciter saturation function value at the corresponding exciter voltage, <i>Ve... | direct |
| ve2 | [cim:ExcELIN2.ve2](http://iec.ch/TC57/CIM100#ExcELIN2.ve2) | 1..1 <br />  [PU](PU.md)  | Exciter alternator output voltages back of commutating reactance at which sat... | direct |
| seve2 | [cim:ExcELIN2.seve2](http://iec.ch/TC57/CIM100#ExcELIN2.seve2) | 1..1 <br />  [PU](PU.md)  | Exciter saturation function value at the corresponding exciter voltage, <i>Ve... | direct |
| tr4 | [cim:ExcELIN2.tr4](http://iec.ch/TC57/CIM100#ExcELIN2.tr4) | 1..1 <br />  [Seconds](Seconds.md)  | Time constant (<i>T</i><i><sub>r4</sub></i>) (&gt;= 0) | direct |
| k3 | [cim:ExcELIN2.k3](http://iec.ch/TC57/CIM100#ExcELIN2.k3) | 1..1 <br />  [PU](PU.md)  | Gain (<i>K3</i>) | direct |
| ti3 | [cim:ExcELIN2.ti3](http://iec.ch/TC57/CIM100#ExcELIN2.ti3) | 1..1 <br />  [Seconds](Seconds.md)  | Time constant (<i>T</i><i><sub>i3</sub></i>) (&gt;= 0) | direct |
| k4 | [cim:ExcELIN2.k4](http://iec.ch/TC57/CIM100#ExcELIN2.k4) | 1..1 <br />  [PU](PU.md)  | Gain (<i>K4</i>) | direct |
| ti4 | [cim:ExcELIN2.ti4](http://iec.ch/TC57/CIM100#ExcELIN2.ti4) | 1..1 <br />  [Seconds](Seconds.md)  | Time constant (<i>T</i><i><sub>i4</sub></i>) (&gt;= 0) | direct |
| iefmax | [cim:ExcELIN2.iefmax](http://iec.ch/TC57/CIM100#ExcELIN2.iefmax) | 1..1 <br />  [PU](PU.md)  | Limiter (<i>I</i><i><sub>efmax</sub></i>) (&gt; ExcELIN2 | direct |
| iefmin | [cim:ExcELIN2.iefmin](http://iec.ch/TC57/CIM100#ExcELIN2.iefmin) | 1..1 <br />  [PU](PU.md)  | Limiter (<i>I</i><i><sub>efmin</sub></i>) (&lt; ExcELIN2 | direct |
| efdbas | [cim:ExcELIN2.efdbas](http://iec.ch/TC57/CIM100#ExcELIN2.efdbas) | 1..1 <br />  [PU](PU.md)  | Gain (<i>Efdbas</i>) | direct |

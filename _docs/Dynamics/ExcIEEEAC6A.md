...
| ---  | --- | --- | --- | --- |
| ka | [cim:ExcIEEEAC6A.ka](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.ka) | 1..1 <br />  [PU](PU.md)  | Voltage regulator gain (<i>K</i><i><sub>A</sub></i>) (&gt; 0) | direct |
| ta | [cim:ExcIEEEAC6A.ta](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.ta) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>A</sub></i>) (&gt;= 0) | direct |
| tk | [cim:ExcIEEEAC6A.tk](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.tk) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>K</sub></i>) (&gt;= 0) | direct |
| tb | [cim:ExcIEEEAC6A.tb](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.tb) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>B</sub></i>) (&gt;= 0) | direct |
| tc | [cim:ExcIEEEAC6A.tc](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.tc) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>C</sub></i>) (&gt;= 0) | direct |
| vamax | [cim:ExcIEEEAC6A.vamax](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.vamax) | 1..1 <br />  [PU](PU.md)  | Maximum voltage regulator output (<i>V</i><i><sub>AMAX</sub></i>) (&gt; 0) | direct |
| vamin | [cim:ExcIEEEAC6A.vamin](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.vamin) | 1..1 <br />  [PU](PU.md)  | Minimum voltage regulator output (V<sub>AMIN</sub>) (&lt; 0) | direct |
| vrmax | [cim:ExcIEEEAC6A.vrmax](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.vrmax) | 1..1 <br />  [PU](PU.md)  | Maximum voltage regulator output (<i>V</i><i><sub>RMAX</sub></i>) (&gt; 0) | direct |
| vrmin | [cim:ExcIEEEAC6A.vrmin](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.vrmin) | 1..1 <br />  [PU](PU.md)  | Minimum voltage regulator output (<i>V</i><i><sub>RMIN</sub></i>) (&lt; 0) | direct |
| te | [cim:ExcIEEEAC6A.te](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.te) | 1..1 <br />  [Seconds](Seconds.md)  | Exciter time constant, integration rate associated with exciter control (<i>T... | direct |
| kh | [cim:ExcIEEEAC6A.kh](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.kh) | 1..1 <br />  [PU](PU.md)  | Exciter field current limiter gain (<i>K</i><i><sub>H</sub></i>) (&gt;= 0) | direct |
| tj | [cim:ExcIEEEAC6A.tj](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.tj) | 1..1 <br />  [Seconds](Seconds.md)  | Exciter field current limiter time constant (<i>T</i><i><sub>J</sub></i>) (&g... | direct |
| th | [cim:ExcIEEEAC6A.th](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.th) | 1..1 <br />  [Seconds](Seconds.md)  | Exciter field current limiter time constant (<i>T</i><i><sub>H</sub></i>) (&g... | direct |
| vfelim | [cim:ExcIEEEAC6A.vfelim](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.vfelim) | 1..1 <br />  [PU](PU.md)  | Exciter field current limit reference (<i>V</i><i><sub>FELIM</sub></i>) (&gt;... | direct |
| vhmax | [cim:ExcIEEEAC6A.vhmax](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.vhmax) | 1..1 <br />  [PU](PU.md)  | Maximum field current limiter signal reference (<i>V</i><i><sub>HMAX</sub></i... | direct |
| kc | [cim:ExcIEEEAC6A.kc](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.kc) | 1..1 <br />  [PU](PU.md)  | Rectifier loading factor proportional to commutating reactance (<i>K</i><i><s... | direct |
| kd | [cim:ExcIEEEAC6A.kd](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.kd) | 1..1 <br />  [PU](PU.md)  | Demagnetizing factor, a function of exciter alternator reactances (<i>K</i><i... | direct |
| ke | [cim:ExcIEEEAC6A.ke](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.ke) | 1..1 <br />  [PU](PU.md)  | Exciter constant related to self-excited field (<i>K</i><i><sub>E</sub></i>) | direct |
| ve1 | [cim:ExcIEEEAC6A.ve1](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.ve1) | 1..1 <br />  [PU](PU.md)  | Exciter alternator output voltages back of commutating reactance at which sat... | direct |
| seve1 | [cim:ExcIEEEAC6A.seve1](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.seve1) | 1..1 <br />  float  | Exciter saturation function value at the corresponding exciter voltage, <i>V<... | direct |
| ve2 | [cim:ExcIEEEAC6A.ve2](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.ve2) | 1..1 <br />  [PU](PU.md)  | Exciter alternator output voltages back of commutating reactance at which sat... | direct |
| seve2 | [cim:ExcIEEEAC6A.seve2](http://iec.ch/TC57/CIM100#ExcIEEEAC6A.seve2) | 1..1 <br />  float  | Exciter saturation function value at the corresponding exciter voltage, <i>V<... | direct |

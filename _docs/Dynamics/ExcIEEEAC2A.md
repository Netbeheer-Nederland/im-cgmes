...
| ---  | --- | --- | --- | --- |
| tb | [cim:ExcIEEEAC2A.tb](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.tb) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>B</sub></i>) (&gt;= 0) | direct |
| tc | [cim:ExcIEEEAC2A.tc](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.tc) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>C</sub></i>) (&gt;= 0) | direct |
| ka | [cim:ExcIEEEAC2A.ka](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.ka) | 1..1 <br />  [PU](PU.md)  | Voltage regulator gain (<i>K</i><i><sub>A</sub></i>) (&gt; 0) | direct |
| ta | [cim:ExcIEEEAC2A.ta](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.ta) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>A</sub></i>) (&gt; 0) | direct |
| vamax | [cim:ExcIEEEAC2A.vamax](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.vamax) | 1..1 <br />  [PU](PU.md)  | Maximum voltage regulator output (<i>V</i><i><sub>AMAX</sub></i>) (&gt; 0) | direct |
| vamin | [cim:ExcIEEEAC2A.vamin](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.vamin) | 1..1 <br />  [PU](PU.md)  | Minimum voltage regulator output (<i>V</i><i><sub>AMIN</sub></i>) (&lt; 0) | direct |
| kb | [cim:ExcIEEEAC2A.kb](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.kb) | 1..1 <br />  [PU](PU.md)  | Second stage regulator gain (<i>K</i><i><sub>B</sub></i>) (&gt; 0) | direct |
| vrmax | [cim:ExcIEEEAC2A.vrmax](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.vrmax) | 1..1 <br />  [PU](PU.md)  | Maximum voltage regulator outputs (<i>V</i><i><sub>RMAX</sub></i>) (&gt; 0) | direct |
| vrmin | [cim:ExcIEEEAC2A.vrmin](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.vrmin) | 1..1 <br />  [PU](PU.md)  | Minimum voltage regulator outputs (<i>V</i><i><sub>RMIN</sub></i>) (&lt; 0) | direct |
| te | [cim:ExcIEEEAC2A.te](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.te) | 1..1 <br />  [Seconds](Seconds.md)  | Exciter time constant, integration rate associated with exciter control (<i>T... | direct |
| vfemax | [cim:ExcIEEEAC2A.vfemax](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.vfemax) | 1..1 <br />  [PU](PU.md)  | Exciter field current limit reference (<i>V</i><i><sub>FEMAX</sub></i>) (&gt;... | direct |
| kh | [cim:ExcIEEEAC2A.kh](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.kh) | 1..1 <br />  [PU](PU.md)  | Exciter field current feedback gain (<i>K</i><i><sub>H</sub></i>) (&gt;= 0) | direct |
| kf | [cim:ExcIEEEAC2A.kf](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.kf) | 1..1 <br />  [PU](PU.md)  | Excitation control system stabilizer gains (<i>K</i><i><sub>F</sub></i>) (&gt... | direct |
| tf | [cim:ExcIEEEAC2A.tf](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.tf) | 1..1 <br />  [Seconds](Seconds.md)  | Excitation control system stabilizer time constant (<i>T</i><i><sub>F</sub></... | direct |
| kc | [cim:ExcIEEEAC2A.kc](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.kc) | 1..1 <br />  [PU](PU.md)  | Rectifier loading factor proportional to commutating reactance (<i>K</i><i><s... | direct |
| kd | [cim:ExcIEEEAC2A.kd](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.kd) | 1..1 <br />  [PU](PU.md)  | Demagnetizing factor, a function of exciter alternator reactances (<i>K</i><i... | direct |
| ke | [cim:ExcIEEEAC2A.ke](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.ke) | 1..1 <br />  [PU](PU.md)  | Exciter constant related to self-excited field (<i>K</i><i><sub>E</sub></i>) ... | direct |
| ve1 | [cim:ExcIEEEAC2A.ve1](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.ve1) | 1..1 <br />  [PU](PU.md)  | Exciter alternator output voltages back of commutating reactance at which sat... | direct |
| seve1 | [cim:ExcIEEEAC2A.seve1](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.seve1) | 1..1 <br />  float  | Exciter saturation function value at the corresponding exciter voltage, <i>V<... | direct |
| ve2 | [cim:ExcIEEEAC2A.ve2](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.ve2) | 1..1 <br />  [PU](PU.md)  | Exciter alternator output voltages back of commutating reactance at which sat... | direct |
| seve2 | [cim:ExcIEEEAC2A.seve2](http://iec.ch/TC57/CIM100#ExcIEEEAC2A.seve2) | 1..1 <br />  float  | Exciter saturation function value at the corresponding exciter voltage, <i>V<... | direct |

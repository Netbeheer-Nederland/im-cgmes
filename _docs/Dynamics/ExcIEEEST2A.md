...
| ---  | --- | --- | --- | --- |
| ka | [cim:ExcIEEEST2A.ka](http://iec.ch/TC57/CIM100#ExcIEEEST2A.ka) | 1 <br />  [PU](PU.md)  | Voltage regulator gain (<i>K</i><i><sub>A</sub></i>) (&gt; 0) | direct |
| ta | [cim:ExcIEEEST2A.ta](http://iec.ch/TC57/CIM100#ExcIEEEST2A.ta) | 1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>T</i><i><sub>A</sub></i>) (&gt; 0) | direct |
| vrmax | [cim:ExcIEEEST2A.vrmax](http://iec.ch/TC57/CIM100#ExcIEEEST2A.vrmax) | 1 <br />  [PU](PU.md)  | Maximum voltage regulator outputs (<i>V</i><i><sub>RMAX</sub></i>) (&gt; 0) | direct |
| vrmin | [cim:ExcIEEEST2A.vrmin](http://iec.ch/TC57/CIM100#ExcIEEEST2A.vrmin) | 1 <br />  [PU](PU.md)  | Minimum voltage regulator outputs (<i>V</i><i><sub>RMIN</sub></i>) (&lt;= 0) | direct |
| ke | [cim:ExcIEEEST2A.ke](http://iec.ch/TC57/CIM100#ExcIEEEST2A.ke) | 1 <br />  [PU](PU.md)  | Exciter constant related to self-excited field (<i>K</i><i><sub>E</sub></i>) | direct |
| te | [cim:ExcIEEEST2A.te](http://iec.ch/TC57/CIM100#ExcIEEEST2A.te) | 1 <br />  [Seconds](Seconds.md)  | Exciter time constant, integration rate associated with exciter control (<i>T... | direct |
| kf | [cim:ExcIEEEST2A.kf](http://iec.ch/TC57/CIM100#ExcIEEEST2A.kf) | 1 <br />  [PU](PU.md)  | Excitation control system stabilizer gains (<i>K</i><i><sub>F</sub></i>) (&gt... | direct |
| tf | [cim:ExcIEEEST2A.tf](http://iec.ch/TC57/CIM100#ExcIEEEST2A.tf) | 1 <br />  [Seconds](Seconds.md)  | Excitation control system stabilizer time constant (<i>T</i><i><sub>F</sub></... | direct |
| kp | [cim:ExcIEEEST2A.kp](http://iec.ch/TC57/CIM100#ExcIEEEST2A.kp) | 1 <br />  [PU](PU.md)  | Potential circuit gain coefficient (<i>K</i><i><sub>P</sub></i>) (&gt;= 0) | direct |
| ki | [cim:ExcIEEEST2A.ki](http://iec.ch/TC57/CIM100#ExcIEEEST2A.ki) | 1 <br />  [PU](PU.md)  | Potential circuit gain coefficient (<i>K</i><i><sub>I</sub></i>) (&gt;= 0) | direct |
| kc | [cim:ExcIEEEST2A.kc](http://iec.ch/TC57/CIM100#ExcIEEEST2A.kc) | 1 <br />  [PU](PU.md)  | Rectifier loading factor proportional to commutating reactance (<i>K</i><i><s... | direct |
| efdmax | [cim:ExcIEEEST2A.efdmax](http://iec.ch/TC57/CIM100#ExcIEEEST2A.efdmax) | 1 <br />  [PU](PU.md)  | Maximum field voltage (<i>E</i><i><sub>FDMax</sub></i>) (&gt;= 0) | direct |
| uelin | [cim:ExcIEEEST2A.uelin](http://iec.ch/TC57/CIM100#ExcIEEEST2A.uelin) | 1 <br />  boolean  | UEL input (<i>UELin</i>) | direct |

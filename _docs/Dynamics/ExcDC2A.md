...
| ---  | --- | --- | --- | --- |
| ka | [cim:ExcDC2A.ka](http://iec.ch/TC57/CIM100#ExcDC2A.ka) | 1..1 <br />  [PU](PU.md)  | Voltage regulator gain (<i>Ka</i>) (&gt; 0) | direct |
| ks | [cim:ExcDC2A.ks](http://iec.ch/TC57/CIM100#ExcDC2A.ks) | 1..1 <br />  [PU](PU.md)  | Coefficient to allow different usage of the model-speed coefficient (<i>Ks</i... | direct |
| ta | [cim:ExcDC2A.ta](http://iec.ch/TC57/CIM100#ExcDC2A.ta) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>Ta</i>) (&gt; 0) | direct |
| tb | [cim:ExcDC2A.tb](http://iec.ch/TC57/CIM100#ExcDC2A.tb) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>Tb</i>) (&gt;= 0) | direct |
| tc | [cim:ExcDC2A.tc](http://iec.ch/TC57/CIM100#ExcDC2A.tc) | 1..1 <br />  [Seconds](Seconds.md)  | Voltage regulator time constant (<i>Tc</i>) (&gt;= 0) | direct |
| vrmax | [cim:ExcDC2A.vrmax](http://iec.ch/TC57/CIM100#ExcDC2A.vrmax) | 1..1 <br />  [PU](PU.md)  | Maximum voltage regulator output (<i>Vrmax</i>) (&gt; ExcDC2A | direct |
| vrmin | [cim:ExcDC2A.vrmin](http://iec.ch/TC57/CIM100#ExcDC2A.vrmin) | 1..1 <br />  [PU](PU.md)  | Minimum voltage regulator output (<i>Vrmin</i>) (&lt; 0 and &lt; ExcDC2A | direct |
| ke | [cim:ExcDC2A.ke](http://iec.ch/TC57/CIM100#ExcDC2A.ke) | 1..1 <br />  [PU](PU.md)  | Exciter constant related to self-excited field (<i>Ke</i>) | direct |
| te | [cim:ExcDC2A.te](http://iec.ch/TC57/CIM100#ExcDC2A.te) | 1..1 <br />  [Seconds](Seconds.md)  | Exciter time constant, integration rate associated with exciter control (<i>T... | direct |
| kf | [cim:ExcDC2A.kf](http://iec.ch/TC57/CIM100#ExcDC2A.kf) | 1..1 <br />  [PU](PU.md)  | Excitation control system stabilizer gain (<i>Kf</i>) (&gt;= 0) | direct |
| tf | [cim:ExcDC2A.tf](http://iec.ch/TC57/CIM100#ExcDC2A.tf) | 1..1 <br />  [Seconds](Seconds.md)  | Excitation control system stabilizer time constant (<i>Tf</i>) (&gt; 0) | direct |
| tf1 | [cim:ExcDC2A.tf1](http://iec.ch/TC57/CIM100#ExcDC2A.tf1) | 1..1 <br />  [Seconds](Seconds.md)  | Excitation control system stabilizer time constant (<i>Tf1</i>) (&gt;= 0) | direct |
| efd1 | [cim:ExcDC2A.efd1](http://iec.ch/TC57/CIM100#ExcDC2A.efd1) | 1..1 <br />  [PU](PU.md)  | Exciter voltage at which exciter saturation is defined (<i>Efd</i><i><sub>1</... | direct |
| seefd1 | [cim:ExcDC2A.seefd1](http://iec.ch/TC57/CIM100#ExcDC2A.seefd1) | 1..1 <br />  float  | Exciter saturation function value at the corresponding exciter voltage, <i>Ef... | direct |
| efd2 | [cim:ExcDC2A.efd2](http://iec.ch/TC57/CIM100#ExcDC2A.efd2) | 1..1 <br />  [PU](PU.md)  | Exciter voltage at which exciter saturation is defined (<i>Efd</i><i><sub>2</... | direct |
| seefd2 | [cim:ExcDC2A.seefd2](http://iec.ch/TC57/CIM100#ExcDC2A.seefd2) | 1..1 <br />  float  | Exciter saturation function value at the corresponding exciter voltage, <i>Ef... | direct |
| exclim | [cim:ExcDC2A.exclim](http://iec.ch/TC57/CIM100#ExcDC2A.exclim) | 1..1 <br />  boolean  | (<i>exclim</i>) | direct |
| vtlim | [cim:ExcDC2A.vtlim](http://iec.ch/TC57/CIM100#ExcDC2A.vtlim) | 1..1 <br />  boolean  | (<i>Vtlim</i>) | direct |

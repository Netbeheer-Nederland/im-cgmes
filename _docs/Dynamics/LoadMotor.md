...
| ---  | --- | --- | --- | --- |
| LoadAggregate | [cim:LoadMotor.LoadAggregate](http://iec.ch/TC57/CIM100#LoadMotor.LoadAggregate) | 1 <br />  [LoadAggregate](LoadAggregate.md)  | Aggregate load to which this aggregate motor (dynamic) load belongs | direct |
| pfrac | [cim:LoadMotor.pfrac](http://iec.ch/TC57/CIM100#LoadMotor.pfrac) | 1 <br />  float  | Fraction of constant-power load to be represented by this motor model (<i>Pfr... | direct |
| lfac | [cim:LoadMotor.lfac](http://iec.ch/TC57/CIM100#LoadMotor.lfac) | 1 <br />  float  | Loading factor (<i>Lfac</i>) | direct |
| ls | [cim:LoadMotor.ls](http://iec.ch/TC57/CIM100#LoadMotor.ls) | 1 <br />  [PU](PU.md)  | Synchronous reactance (<i>Ls</i>) | direct |
| lp | [cim:LoadMotor.lp](http://iec.ch/TC57/CIM100#LoadMotor.lp) | 1 <br />  [PU](PU.md)  | Transient reactance (<i>Lp</i>) | direct |
| lpp | [cim:LoadMotor.lpp](http://iec.ch/TC57/CIM100#LoadMotor.lpp) | 1 <br />  [PU](PU.md)  | Subtransient reactance (<i>Lpp</i>) | direct |
| ra | [cim:LoadMotor.ra](http://iec.ch/TC57/CIM100#LoadMotor.ra) | 1 <br />  [PU](PU.md)  | Stator resistance (<i>Ra</i>) | direct |
| tpo | [cim:LoadMotor.tpo](http://iec.ch/TC57/CIM100#LoadMotor.tpo) | 1 <br />  [Seconds](Seconds.md)  | Transient rotor time constant (<i>Tpo</i>) (&gt;= 0) | direct |
| tppo | [cim:LoadMotor.tppo](http://iec.ch/TC57/CIM100#LoadMotor.tppo) | 1 <br />  [Seconds](Seconds.md)  | Subtransient rotor time constant (<i>Tppo</i>) (&gt;= 0) | direct |
| h | [cim:LoadMotor.h](http://iec.ch/TC57/CIM100#LoadMotor.h) | 1 <br />  [Seconds](Seconds.md)  | Inertia constant (<i>H</i>) (&gt;= 0) | direct |
| d | [cim:LoadMotor.d](http://iec.ch/TC57/CIM100#LoadMotor.d) | 1 <br />  float  | Damping factor (<i>D</i>) | direct |
| vt | [cim:LoadMotor.vt](http://iec.ch/TC57/CIM100#LoadMotor.vt) | 1 <br />  [PU](PU.md)  | Voltage threshold for tripping (<i>Vt</i>) | direct |
| tv | [cim:LoadMotor.tv](http://iec.ch/TC57/CIM100#LoadMotor.tv) | 1 <br />  [Seconds](Seconds.md)  | Voltage trip pickup time (<i>Tv</i>) (&gt;= 0) | direct |
| tbkr | [cim:LoadMotor.tbkr](http://iec.ch/TC57/CIM100#LoadMotor.tbkr) | 1 <br />  [Seconds](Seconds.md)  | Circuit breaker operating time (<i>Tbkr</i>) (&gt;= 0) | direct |
